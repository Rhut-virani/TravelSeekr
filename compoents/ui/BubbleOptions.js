...
export default BubbleOptions = (props) => {
    ...
    const bubbleJSX = options[icon].map((e, i)=>{
        return (
        <View style={{backgroundColor:"#e1f3ef", borderRadius:25, alignSelf: 'flex-start', margin:"1%"}} key={i}>
            <Text style={{color:"#5acbcb", fontWeight:"bold",textAlign:"center", padding: "2%"}}>{e}</Text>
        </View>
        )
    })
    return (
