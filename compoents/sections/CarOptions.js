        ...
        <View style={{
                ...
                <View style={[styles.cards, {height: slideHeight, width: slideWidth}]}>
                    ...
                    <View style={{flex:1, padding:"3%", maxHeight:"50%"}}>
                        ...
                        <View style={{flex:1, paddingLeft:"3%", paddingRight:"3%", paddingBottom:"3%"}}>
                    ...
                    {/* name and type */}
                                ...
                                <View style={{flex:4, alignSelf:"center"}}>
                                    <Text style={{ color: '#000', fontSize: wp("4%"), fontWeight:"bold"}}>
                                        {item.name}{"  "}
                                        <Text style={{color:'#ADADAD', fontSize: wp("3.5%")}}>or similar</Text>
                                    </Text>
                                </View>

                                <View style={{flex:2, alignSelf:"center", alignContent:"flex-end"}}>
                                    <Image 
                    ...
                    {/* bags and deals */}
                            ...
                            <View style={{flex:1, flexDirection:"row"}}>
                                <Text style={{ color: '#ADADAD', fontSize: wp("3%"), flex: 4}}>
                                    {item.lBags} Large {"  "}{item.sBags} Small Bags
                                </Text>
                                <Text style={{ color: '#ADADAD', fontSize: wp("3%"), flex: 2, textAlign:"right"}}>
                                    {item.deal}
                                </Text>
                            </View>
                    ...
                    {/* pickup and price */}
                            ...
                            <View style={{flex:1, flexDirection:"row"}}>
                                ...
                                <Text style={{ flex:2, alignContent:"center", color: '#ADADAD', fontSize: wp("3%")}}>
                                    Pick Up : 
                                ...
                                <Text style={{ 
                                    ...
                                    C$ {item.ratePerDay} 
                                    <Text style={{ color: '#ADADAD', fontSize: wp("3%")}}>{" "}/ Day</Text>
