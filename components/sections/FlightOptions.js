	...
	return (
		...
		>
			<View
				style={[
					styles.cardsWrapper,
					{ height: slideHeight / 2, width: slideWidth }
				]}
			>
				<View style={styles.card}>
					<View style={styles.cardsContent}>
						<View style={styles.cardsSection1}>
							<View style={{ flex: 4 }}>
								<Text>Departing . {item.detarutureDate}</Text>
							</View>
							<View style={styles.select}>
								<Text style={{ textAlign: "right" }}>Shortest </Text>
							</View>
						...
						<View style={styles.cardsSecion3}>
							<View style={{ flex: 4 }}>
								<Text style={{ fontSize: wp("3%"), textAlign: "left" }}>
									{item.stops ? item.stops : "Non"} Stop . {item.duration} .{" "}
									{item.name}
								</Text>
							</View>
							<View style={{ flex: 2 }}>
			...
			<View
				style={[
					styles.cardsWrapper,
					{ height: slideHeight / 2, width: slideWidth, marginTop: wp("3%") }
				]}
			>
				<View style={styles.card}>
					<View style={styles.cardsContent}>
						<View style={styles.cardsSection1}>
							<View style={{ flex: 4 }}>
								<Text>Departing . {item.returnDetarutureDate}</Text>
							</View>
							<View style={styles.select}>
								<Text style={{ textAlign: "right" }}>Shortest </Text>
							</View>
						...
						<View style={styles.cardsSecion3}>
							<View style={{ flex: 4 }}>
								<Text style={{ fontSize: wp("3%"), textAlign: "left" }}>
									{item.returnStops ? item.returnStops : "Non"} Stop .{" "}
									{item.returnDuration} . {item.returnName}
								</Text>
							</View>
